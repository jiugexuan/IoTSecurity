...
public class RSAUtil {
    ...
    public static Map<String, String> createKeys(int keySize,String KEY_STR) throws NoSuchAlgorithmException {
    ...
    public static String privateEncrypt(String data, String priKey){
        try{
            RSAPrivateKey privateKey=getPrivateKey(priKey);
            Cipher cipher = Cipher.getInstance(RSA_ALGORITHM);
    ...
    public static String publicDecrypt(String data, String pubKey){
        try{
            RSAPublicKey publicKey=getPublicKey(pubKey);
            Cipher cipher = Cipher.getInstance(RSA_ALGORITHM);
